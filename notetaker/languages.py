...
_ENGLISH_MAP_SCHOOL = (
    ...
    "- Only do that for real subject vocabulary. A person's name, a book, or a "
    "website is NOT a word to define: if you cannot say what it means without "
    "guessing, leave it out.\n"
...
_ENGLISH_REDUCE_SCHOOL = (
    ...
    "- Drop any 'word to know' whose meaning is vague, circular, or clearly a "
    "mis-heard word rather than real subject vocabulary. A wrong definition is "
...
_THAI_MAP_SCHOOL = (
    ...
    "- ทำแบบนี้เฉพาะศัพท์วิชาการจริงๆ ชื่อคน ชื่อหนังสือ หรือชื่อเว็บไซต์ "
    "ไม่ใช่คำศัพท์ที่ต้องนิยาม ถ้าไม่แน่ใจความหมาย ไม่ต้องใส่\n"
...
_THAI_REDUCE_SCHOOL = (
    ...
    "- ตัดคำศัพท์ที่ความหมายคลุมเครือ วนไปวนมา หรือดูเหมือนถอดเสียงผิด ออก "
    "นิยามที่ผิดแย่กว่าไม่มีนิยาม\n"
